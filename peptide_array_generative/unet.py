...
class UNet(nn.Module):
    def __init__(self, channels=3, time_dim=256, conditional_dim=None):
        super().__init__()
        ...
        if conditional_dim is not None:
            self.conditional_embedding = nn.Linear(conditional_dim, time_dim)
    ...
    def forward(self, x, t, y=None):
        ...
        if y is not None:
            t += self.conditional_embedding(y)
